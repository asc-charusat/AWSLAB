...
<ol start="13">
  <li>To connect to EC2 instance dowmload ppk file by clicking: <a href="KeyPairFile" download><strong>Download PPK</strong></a>.</li>
  <li>Save the file to the directory of your choice.</li>
</ol>
<p>You will use PuTTY to SSH to Amazon EC2 instances.</p>
<p>If you do not have PuTTY installed on your computer, <a href="LinkToDownloadPutty" download>download it here</a>.</p>
<ol start="15">
